...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: BotShield): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: BotShield): Logger {

...
const remoteStainlessHandler = async (
  ...
  const localClientEnvs = { BOTSHIELD_API_KEY: readEnv('BOTSHIELD_API_KEY') ?? client.apiKey ?? undefined, BOT_SHIELD_BASE_URL: readEnv('BOT_SHIELD_BASE_URL') ?? readEnv('BOT_SHIELD_ENVIRONMENT') ? undefined : client.baseURL ?? undefined };

...
export const parseClientAuthHeaders = (req: IncomingMessage, required?: boolean): Partial<ClientOptions> => { const apiKey = Array.isArray(req.headers['x-botshield-api-key']) ? req.headers['x-botshield-api-key'][0] : req.headers['x-botshield-api-key']
return {apiKey}; }

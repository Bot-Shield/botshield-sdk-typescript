...
- <code><a href="./src/resources/sdk.ts">SDKGetPartnerConfigResponse</a></code>
...
- <code><a href="./src/resources/sdk.ts">SDKStoreSignalResponse</a></code>
- <code><a href="./src/resources/sdk.ts">SDKValidateSignalResponse</a></code>
...
- <code title="get /sdk/partner-config">client.sdk.<a href="./src/resources/sdk.ts">getPartnerConfig</a>({ ...params }) -> SDKGetPartnerConfigResponse</code>
...
- <code title="post /sdk/store-signal">client.sdk.<a href="./src/resources/sdk.ts">storeSignal</a>({ ...params }) -> SDKStoreSignalResponse</code>
- <code title="post /sdk/validate-signal">client.sdk.<a href="./src/resources/sdk.ts">validateSignal</a>({ ...params }) -> SDKValidateSignalResponse</code>
